...
public class QpidRAManagedConnection implements ManagedConnection, ExceptionListener
{
   ...
   /** Handles */
   private final Set<QpidRASession> handles;
   ...
   public synchronized Object getConnection(final Subject subject, final ConnectionRequestInfo cxRequestInfo) throws ResourceException
   {
      ...
      // Check user first
      QpidRACredential credential = QpidRACredential.getCredential(mcf, subject, cxRequestInfo);
      ...
      QpidRASession session = new QpidRASession(this, (QpidRAConnectionRequestInfo)cxRequestInfo);
      handles.add(session);
      return session;
   }
   ...
   public void associateConnection(final Object obj) throws ResourceException
   {
      ...
      {
         QpidRASession h = (QpidRASession)obj;
